<template>
  <PageContainer class="sm:pb-12 pb-8" >
    <PageHead headline="Terms of Use" />
    <img class="mb-4" src="/assets/images/cc-by-sa-4-0.png" alt="Graphic for CC-BY-SA 4.0 license"/>
    <p>GEOROC data are compiled from published, peer-reviewed literature and are provided here under Creative Commons regulations (<a class="text-primary hover:border-primary hover:border-b-2" href="https://creativecommons.org/licenses/by-sa/4.0/" title="Link to License Website" target="_blank">CC BY-SA 4.0</a>).
      Use of GEOROC data compilations requires appropriate citation of all data sources. GEOROC datasets can only be distributed under the same license as the original.
      See our <BaseNuxtLink to="/how-to-cite" class="text-primary">citation guidelines</BaseNuxtLink> for further information.
      <br><br>
      By using the GEOROC data you agree to and accept these terms.
    </p>
    <h2 id="disclaimer" class="font-bold text-xl mt-8 mb-6 scroll-mt-20">Disclaimer</h2>
    <p class="mb-6">
    ...
    <p class="mb-6">
      Read more on
      <BaseNuxtLink class="text-primary" to="/how-to-contribute" target="_blank">how you can contribute</BaseNuxtLink> to improving GEOROC and to ensuring consistently high-quality data going forward.
    </p>
    <p class="mb-6">
    ...
    <ul class="list-disc pl-8 mb-4">
      ...
      <li>
        ...
        well as to the original data sources.
        This includes proper referencing in a publication’s list of cited references (see below).
      </li>
      <li>
        If you remix, transform, or build upon the material, you <span class="underline font-bold">must</span> distribute your contributions under the same license as the original.
      </li>
    </ul>
    <p>
    ...
    <h2 id="how-to-cite" class="font-bold text-xl mt-8 mb-6 scroll-mt-20">Please follow these guidelines for how to cite GEOROC data.</h2>
    <h3 class="font-semibold text-lg mb-2">Data Download from Database Query</h3>
    <p class="mb-6">
      To cite the GEOROC database, please reference its URL in text and in figure captions: <span class="underline">https://georoc.eu/</span>.
      Please <span class="font-bold">cite the specific download by giving the date and, if possible, parameters of the query.</span>
      A summary of the query criteria may be viewed on the download page.
    </p>
    <h3 class="font-semibold text-lg mb-2">Example for manuscript text and figures:</h3>
    <p class="mb-6">
    ...
    <p class="mb-6">
      You should also <span class="font-bold">cite the original references that contribute to the downloaded dataset.</span>
    ...
    <h3 class="font-semibold mb-2">Example for citation in text and reference lists in scientific publications:</h3>
    <p class="mb-6">
    ...
    <h3 class="font-semibold text-lg mt-8 mb-2">Citing Precompiled Files and Expert Datasets from the GEOROC Data Repository</h3>
    ...
    <h2 id="how-to-filter" class="font-bold text-xl mt-8 mb-6 scroll-mt-20">How to Filter</h2>
    <HowToFilter />
  </PageContainer>
</template>
