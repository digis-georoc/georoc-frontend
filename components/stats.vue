    ...
    <BaseFluidContainer>
      ...
      >
        <div v-if="pending || stats" class="grow pt-5 md:pb-5">
          <div
            v-if="pending && !stats"
            class="flex h-full justify-center items-center text-gray-700 dark:text-graye-400"
          >
            <BaseLoading class="w-12 h-12 my-5"></BaseLoading>
          </div>
          <div v-else-if="stats" class="flex flex-wrap h-full">
            <div
              class="border-r border-gray-300 dark:border-gray-700 flex flex-col w-1/2 md:w-1/5 text-center p-4 md:p-2 lg:p-4"
            >
              <span class="text-2xl">{{
            ...
            <div
              class="md:border-r border-gray-300 dark:border-gray-700 flex flex-col w-1/2 md:w-1/5 text-center p-4 md:p-2 lg:p-4"
            >
              <span class="text-2xl">{{
            ...
            <div
              class="border-t md:border-t-0 md:border-l border-gray-300 dark:border-gray-700 flex flex-col w-full md:w-1/5 text-center p-4 md:p-2 lg:p-4"
            >
              <span class="text-2xl">{{
